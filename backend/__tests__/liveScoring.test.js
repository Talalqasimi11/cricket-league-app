...
describe('Live Scoring API', () => {
  ...
  beforeAll(async () => {
    ...
    const [matchResult] = await db.query(
      'INSERT INTO matches (tournament_id, team1_id, team2_id, match_datetime, venue, status, overs, creator_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
      [testTournament.id, testTeam1.id, testTeam2.id, '2024-01-01 10:00:00', 'Test Venue', 'live', 20, testUser.id]
    );
