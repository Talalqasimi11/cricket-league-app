...
class _ScorecardScreenState extends State<ScorecardScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          DataTable(
            ...
            headingTextStyle: const TextStyle(color: Colors.grey, fontSize: 13),
  ...
  Widget build(BuildContext context) {
    // Dummy data for demo (replace with real match data)
    final teamABatting = [
      {"name": "Player A1", "runs": "45", "balls": "30", "fours": "6", "sixes": "2", "sr": "150"},
      {"name": "Player A2", "runs": "20", "balls": "25", "fours": "2", "sixes": "0", "sr": "80"},
    ];

    final teamBBatting = [
      {"name": "Player B1", "runs": "60", "balls": "40", "fours": "8", "sixes": "1", "sr": "150"},
      {"name": "Player B2", "runs": "10", "balls": "15", "fours": "1", "sixes": "0", "sr": "66"},
    ];
